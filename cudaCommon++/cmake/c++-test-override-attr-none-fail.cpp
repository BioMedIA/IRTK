...
<title>Cross Reference: /kde/Libraries/kactivities/cmake/modules/c++-test-override-attr-none-fail.cpp</title>
</head><body>
<script type="text/javascript">/* <![CDATA[ */
    document.hash = 'null';document.rev = '';document.link = '/source/xref/kde/Libraries/kactivities/cmake/modules/c%2B%2B-test-override-attr-none-fail.cpp';document.annotate = false;
...
<span id="partner">
    ...
    <div id="pagetitle"><span id="filename"
                    >Cross Reference: c++-test-override-attr-none-fail.cpp</span></div>
</div>
<div id="Masthead">
    <tt><a href="/source/xref/">xref</a>: /<a href="/source/xref/kde/">kde</a>/<a href="/source/xref/kde/Libraries/">Libraries</a>/<a href="/source/xref/kde/Libraries/kactivities/">kactivities</a>/<a href="/source/xref/kde/Libraries/kactivities/cmake/">cmake</a>/<a href="/source/xref/kde/Libraries/kactivities/cmake/modules/">modules</a>/<a href="/source/xref/kde/Libraries/kactivities/cmake/modules/c%2B%2B-test-override-attr-none-fail.cpp">c++-test-override-attr-none-fail.cpp</a></tt>
</div>
<div id="bar">
    <ul>
        <li><a href="/source/"><span id="home"></span>Home</a></li><li><a href="/source/history/kde/Libraries/kactivities/cmake/modules/c%2B%2B-test-override-attr-none-fail.cpp"><span id="history"></span>History</a></li><li><a href="#" onclick="javascript:get_annotations(); return false;"
            ...
            title="Show or hide symbol list."><span id="defbox"></span>Navigate</a></li><li><a href="/source/raw/kde/Libraries/kactivities/cmake/modules/c%2B%2B-test-override-attr-none-fail.cpp"><span id="download"></span>Download</a></li><li><input type="text" id="search" name="q" class="q" />
            <input type="submit" value="Search" class="submit" /></li><li><input type="checkbox" name="path" value="/kde/Libraries/kactivities/cmake/modules/" /> only in <b>c++-test-override-attr-none-fail.cpp</b></li>
...
function get_sym_list(){return [["Class","xc",[["A",3],["B",11]]],["Function","xf",[["fn",5],["fn",13],["main",19]]]];} /* ]]> */</script><a class="l" name="1" href="#1">1</a>#<b>include</b> &lt;<a href="/source/s?path=iostream">iostream</a>&gt;
...
<a class="l" name="6" href="#6">6</a>            <b>return</b> <span class="n">10</span> * <a href="/source/s?defs=arg&amp;project=kde">arg</a>;
...
<a class="l" name="13" href="#13">13</a>        <b>virtual</b> <b>int</b> <a class="xf" name="fn"/><a href="/source/s?refs=fn&amp;project=kde" class="xf">fn</a>(<b>long</b> <a class="xa" name="arg"/><a href="/source/s?refs=arg&amp;project=kde" class="xa">arg</a>) <a href="/source/s?defs=__attribute__&amp;project=kde">__attribute__</a>((<a href="/source/s?defs=override&amp;project=kde">override</a>)) {
<a class="l" name="14" href="#14">14</a>            <b>return</b> <span class="n">20</span> * <a href="/source/s?defs=arg&amp;project=kde">arg</a>;
...
<a class="l" name="24" href="#24">24</a>    <b>int</b> <a class="xl" name="result"/><a href="/source/s?refs=result&amp;project=kde" class="xl">result</a> = a-&gt;<a href="/source/s?defs=fn&amp;project=kde">fn</a>(<span class="n">2</span>) - b-&gt;<a href="/source/s?defs=fn&amp;project=kde">fn</a>(<span class="n">1</span>);
