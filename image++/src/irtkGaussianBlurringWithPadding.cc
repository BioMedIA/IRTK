...
template class irtkGaussianBlurringWithPadding<irtkBytePixel>;
template class irtkGaussianBlurringWithPadding<irtkGreyPixel>;
template class irtkGaussianBlurringWithPadding<irtkRealPixel>;
