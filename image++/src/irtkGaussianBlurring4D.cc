...
template class irtkGaussianBlurring4D<irtkBytePixel>;
template class irtkGaussianBlurring4D<irtkGreyPixel>;
template class irtkGaussianBlurring4D<irtkRealPixel>;
