...
void usage()
{
  cerr << "Usage: msareg [number of surfaces] [target] [source] <options> \n" << endl;
...
int main(int argc, char **argv)
{
  ...
  // Create registration
  irtkMultipleSurfaceAffineRegistration *registration = new  irtkMultipleSurfaceAffineRegistration;
