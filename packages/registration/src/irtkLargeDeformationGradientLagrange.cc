...
template <class VoxelType> void LargeDefGradLagrange<VoxelType>::AllocateAllVariables(void){
  ...
  this->NXfft=(int)(pow(2.,floor(log((double)this->NX)+0.99999)/log(2.))+0.00001); //smaller size higher than 'this->NX' and being a power of 2
  this->NYfft=(int)(pow(2.,floor(log((double)this->NY)+0.99999)/log(2.))+0.00001); // ... 'this->NY' ...
  this->NZfft=(int)(pow(2.,floor(log((double)this->NZ)+0.99999)/log(2.))+0.00001); // ... 'this->NZ' ...
