...
void irtkIntensityMatching::WeightedLeastSqaures(double *x1, double *y1, double *weights, int no)
{
  cerr<<"Start weighted least square regression"<<endl;
...
void irtkIntensityMatching::MatchMeanAndVariance(double *x1, double *y1, double *weights, int no)
{
