...
#else
irtkAffineTransformation irtkSegmentationFunction::DetectObject (irtkRealImage *threshold, irtkGreyImage *target, int oxsize, double fscale)
{
	cerr<<"must have Opencv in order to detect an object"<<endl;
	exit(1);
}
#endif
